...
export class ProductoUpdateComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private serBuscarProducto: ProductoService,
     private form: FormBuilder,
    private router: Router, private serEstado: CiudadService, 
    private serCategoria: CategoriaService, private storage: Storage,
